...
if (typeof window !== 'undefined') {
  ...
  // The actual service worker (dist/sw.js, generated by vite-plugin-pwa) is registered by
  // PWAUpdateToast via virtual:pwa-register/react — registering a second, differently-named
  // '/service-worker.js' here always 404'd (no such file exists in the build) and offered
  // nothing but a wasted, always-failing registration attempt.
}
